...
void SMP::disassemble_opcode(char *output, uint16 addr) {
  ...
  switch(op) {
    ...
    case 0x0a: sprintf(t, "or1   c,$%.4x:%" PRId32 "", opw & 0x1fff, opw >> 13);  break;
    ...
    case 0x2a: sprintf(t, "or1   c,!$%.4x:%" PRId32 "", opw & 0x1fff, opw >> 13); break;
    ...
    case 0x4a: sprintf(t, "and1  c,$%.4x:%" PRId32 "", opw & 0x1fff, opw >> 13);  break;
    ...
    case 0x6a: sprintf(t, "and1  c,!$%.4x:%" PRId32 "", opw & 0x1fff, opw >> 13); break;
    ...
    case 0x8a: sprintf(t, "eor1  c,$%.4x:%" PRId32 "", opw & 0x1fff, opw >> 13);  break;
    ...
    case 0xaa: sprintf(t, "mov1  c,$%.4x:%" PRId32 "", opw & 0x1fff, opw >> 13);  break;
    ...
    case 0xca: sprintf(t, "mov1  $%.4x:%" PRId32 ",c", opw & 0x1fff, opw >> 13);  break;
    ...
    case 0xea: sprintf(t, "not1  c,$%.4x:%" PRId32 "", opw & 0x1fff, opw >> 13);  break;
